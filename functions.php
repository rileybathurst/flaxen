	...
	// When the captcha is checked make sure its not spam
        ...
        wp_mail($email, $subject, $message);
			...
			if ($id>0)  {
				...
				// $to				= 'authenticalignmentwellness@gmail.com';
				$developer		= 'riley@rileybathurst.com';
				$subject		= 'Authentic Alignment Wellness Discovery Session for: '.$name;

				//write email saved in the email.html files for reference I might be able to do something smarter pulling this in
				$message = '
