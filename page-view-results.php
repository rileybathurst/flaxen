...
<div class="main">
		 ...
		 <!-- search form -->
		 <form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" class="class=col-1 col-end-4 row-1 large-col-5 large-col-end-8">
	...
	<div class="class=col-1 col-end-4 row-2 large-col-5 large-col-end-8">
